package com.example.franc.facedetectiontensoflow;
...
import com.example.franc.facedetectiontensoflow.util.ImageUtils;
import com.example.franc.facedetectiontensoflow.util.Recognition;

import java.nio.ByteBuffer;
import java.util.List;

public class MainActivity extends AppCompatActivity implements ImageReader.OnImageAvailableListener, CameraFragment.ConnectionCallback {
    ...
    public void onPreviewSizeChosen(final Size size, final int rotation) {
        ...
        classifier = new TensorFlowImageClassifier(getAssets(),
                MODEL_FILE,
                LABEL_FILE,
                INPUT_SIZE,
                IMAGE_MEAN,
